...
import com.speakin.recorder.module.control.socket.data.TextMsgEntity;
import com.speakin.recorder.module.control.socket.data.VoiceMsgEntity;
...
public class MsgSendHandler extends Thread {
    ...
    private OutputStream mOutputString = null;
...
//	private String mKey;
	 ...
	 * @param dos
	 */
	private void doFileSend(VoiceMsgEntity entity, MsgRequest.SendCallback callback) {
...
//			e.printStackTrace();
	 ...
	 * @param entity
	 */
	private void doTextSend(TextMsgEntity entity, MsgRequest.SendCallback callback) {
